...
import { range, type WeekDayNumber } from "../helpers/helpers";
...
type DailyForecastGroupProps = LoadingProps | ReadyProps;

export default function DailyForecastGroup(props: DailyForecastGroupProps) {
  if (props.loading)
    return (
      <Wrapper>
        <h1>Loading!</h1>
